...
const Description = () => {
  return (
    <Section>
      ...
      <p>Nos prestations de sablage sont proposées à des <strong>tarifs attractifs</strong>. Sur votre demande, nous effectuons également des travaux de <Link href="/peinture-fluide"><a>peinture fluide</a></Link>.</p><br />
